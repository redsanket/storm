...
public class SupervisorInfo implements org.apache.thrift.TBase<SupervisorInfo, SupervisorInfo._Fields>, java.io.Serializable, Cloneable, Comparable<SupervisorInfo> {
      ...
      if (struct.used_ports != null) {
        if (struct.is_set_used_ports()) {
          oprot.writeFieldBegin(USED_PORTS_FIELD_DESC);
          {
            ...
            for (long _iter380 : struct.used_ports)
            {
              oprot.writeI64(_iter380);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.scheduler_meta != null) {
        if (struct.is_set_scheduler_meta()) {
          oprot.writeFieldBegin(SCHEDULER_META_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter382 : struct.scheduler_meta.entrySet())
            {
  ...
  private static class SupervisorInfoTupleScheme extends TupleScheme<SupervisorInfo> {
      ...
      if (struct.is_set_used_ports()) {
        {
          ...
          for (long _iter383 : struct.used_ports)
          {
      ...
      if (struct.is_set_scheduler_meta()) {
        {
          ...
          for (Map.Entry<String, String> _iter385 : struct.scheduler_meta.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, SupervisorInfo struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list386 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.used_ports = new ArrayList<Long>(_list386.size);
          long _elem387;
          for (int _i388 = 0; _i388 < _list386.size; ++_i388)
          {
            _elem387 = iprot.readI64();
            struct.used_ports.add(_elem387);
          }
        }
        struct.set_used_ports_isSet(true);
      }
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TList _list389 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I64, iprot.readI32());
          struct.meta = new ArrayList<Long>(_list389.size);
          long _elem390;
          for (int _i391 = 0; _i391 < _list389.size; ++_i391)
          {
            _elem390 = iprot.readI64();
            struct.meta.add(_elem390);
          }
        }
        struct.set_meta_isSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.scheduler_meta = new HashMap<String,String>(2*_map392.size);
          String _key393;
          String _val394;
          for (int _i395 = 0; _i395 < _map392.size; ++_i395)
          {
            ...
            struct.scheduler_meta.put(_key393, _val394);
          }
        }
        struct.set_scheduler_meta_isSet(true);
      }
