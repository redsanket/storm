            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map626.size);
                String _key627;
                ThriftSerializedObject _val628;
                for (int _i629 = 0; _i629 < _map626.size; ++_i629)
                {
                  _key627 = iprot.readString();
                  _val628 = new ThriftSerializedObject();
                  _val628.read(iprot);
                  struct.serialized_parts.put(_key627, _val628);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalStateData struct) throws org.apache.thrift.TException {
      ...
      if (struct.serialized_parts != null) {
        oprot.writeFieldBegin(SERIALIZED_PARTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, ThriftSerializedObject> _iter630 : struct.serialized_parts.entrySet())
          {
  ...
  private static class LocalStateDataTupleScheme extends TupleScheme<LocalStateData> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, ThriftSerializedObject> _iter631 : struct.serialized_parts.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalStateData struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.serialized_parts = new HashMap<String,ThriftSerializedObject>(2*_map632.size);
        String _key633;
        ThriftSerializedObject _val634;
        for (int _i635 = 0; _i635 < _map632.size; ++_i635)
        {
          _key633 = iprot.readString();
          _val634 = new ThriftSerializedObject();
          _val634.read(iprot);
          struct.serialized_parts.put(_key633, _val634);
        }
      }
      struct.set_serialized_parts_isSet(true);
    }
