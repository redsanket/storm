            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map654.size);
                int _key655;
                LocalAssignment _val656;
                for (int _i657 = 0; _i657 < _map654.size; ++_i657)
                {
                  _key655 = iprot.readI32();
                  _val656 = new LocalAssignment();
                  _val656.read(iprot);
                  struct.assignments.put(_key655, _val656);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      if (struct.assignments != null) {
        oprot.writeFieldBegin(ASSIGNMENTS_FIELD_DESC);
        {
          ...
          for (Map.Entry<Integer, LocalAssignment> _iter658 : struct.assignments.entrySet())
          {
  ...
  private static class LSSupervisorAssignmentsTupleScheme extends TupleScheme<LSSupervisorAssignments> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<Integer, LocalAssignment> _iter659 : struct.assignments.entrySet())
        {
          oprot.writeI32(_iter659.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSSupervisorAssignments struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TMap _map660 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.assignments = new HashMap<Integer,LocalAssignment>(2*_map660.size);
        int _key661;
        LocalAssignment _val662;
        for (int _i663 = 0; _i663 < _map660.size; ++_i663)
        {
          _key661 = iprot.readI32();
          _val662 = new LocalAssignment();
          _val662.read(iprot);
          struct.assignments.put(_key661, _val662);
        }
      }
      struct.set_assignments_isSet(true);
    }
