            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.executors = new ArrayList<ExecutorInfo>(_list490.size);
                ExecutorInfo _elem491;
                for (int _i492 = 0; _i492 < _list490.size; ++_i492)
                {
                  _elem491 = new ExecutorInfo();
                  _elem491.read(iprot);
                  struct.executors.add(_elem491);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      if (struct.executors != null) {
        oprot.writeFieldBegin(EXECUTORS_FIELD_DESC);
        {
          ...
          for (ExecutorInfo _iter493 : struct.executors)
          {
  ...
  private static class LocalAssignmentTupleScheme extends TupleScheme<LocalAssignment> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.topology_id);
      {
        ...
        for (ExecutorInfo _iter494 : struct.executors)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LocalAssignment struct) throws org.apache.thrift.TException {
      ...
      struct.set_topology_id_isSet(true);
      {
        ...
        struct.executors = new ArrayList<ExecutorInfo>(_list495.size);
        ExecutorInfo _elem496;
        for (int _i497 = 0; _i497 < _list495.size; ++_i497)
        {
          _elem496 = new ExecutorInfo();
          _elem496.read(iprot);
          struct.executors.add(_elem496);
        }
      }
      struct.set_executors_isSet(true);
    }
