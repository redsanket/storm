            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.approved_workers = new HashMap<String,Integer>(2*_map644.size);
                String _key645;
                int _val646;
                for (int _i647 = 0; _i647 < _map644.size; ++_i647)
                {
                  ...
                  struct.approved_workers.put(_key645, _val646);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      ...
      if (struct.approved_workers != null) {
        oprot.writeFieldBegin(APPROVED_WORKERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Integer> _iter648 : struct.approved_workers.entrySet())
          {
  ...
  private static class LSApprovedWorkersTupleScheme extends TupleScheme<LSApprovedWorkers> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (Map.Entry<String, Integer> _iter649 : struct.approved_workers.entrySet())
        {
          oprot.writeString(_iter649.getKey());
          oprot.writeI32(_iter649.getValue());
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LSApprovedWorkers struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.approved_workers = new HashMap<String,Integer>(2*_map650.size);
        String _key651;
        int _val652;
        for (int _i653 = 0; _i653 < _map650.size; ++_i653)
        {
          ...
          struct.approved_workers.put(_key651, _val652);
        }
      }
      struct.set_approved_workers_isSet(true);
    }
