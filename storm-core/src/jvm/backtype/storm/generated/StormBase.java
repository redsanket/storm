            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map454.size);
                String _key455;
                DebugOptions _val456;
                for (int _i457 = 0; _i457 < _map454.size; ++_i457)
                {
                  _key455 = iprot.readString();
                  _val456 = new DebugOptions();
                  _val456.read(iprot);
                  struct.component_debug.put(_key455, _val456);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter458 : struct.component_executors.entrySet())
            {
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter459 : struct.component_debug.entrySet())
            {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter461 : struct.component_debug.entrySet())
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map466.size);
          String _key467;
          DebugOptions _val468;
          for (int _i469 = 0; _i469 < _map466.size; ++_i469)
          {
            _key467 = iprot.readString();
            _val468 = new DebugOptions();
            _val468.read(iprot);
            struct.component_debug.put(_key467, _val468);
          }
        }
        struct.set_component_debug_isSet(true);
      }
