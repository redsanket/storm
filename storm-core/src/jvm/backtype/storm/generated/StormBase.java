...
public class StormBase implements org.apache.thrift.TBase<StormBase, StormBase._Fields>, java.io.Serializable, Cloneable, Comparable<StormBase> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_executors = new HashMap<String,Integer>(2*_map596.size);
                String _key597;
                int _val598;
                for (int _i599 = 0; _i599 < _map596.size; ++_i599)
                {
                  ...
                  struct.component_executors.put(_key597, _val598);
                }
                iprot.readMapEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.component_debug = new HashMap<String,DebugOptions>(2*_map600.size);
                String _key601;
                DebugOptions _val602;
                for (int _i603 = 0; _i603 < _map600.size; ++_i603)
                {
                  _key601 = iprot.readString();
                  _val602 = new DebugOptions();
                  _val602.read(iprot);
                  struct.component_debug.put(_key601, _val602);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.component_executors != null) {
        if (struct.is_set_component_executors()) {
          oprot.writeFieldBegin(COMPONENT_EXECUTORS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, Integer> _iter604 : struct.component_executors.entrySet())
            {
              oprot.writeString(_iter604.getKey());
              oprot.writeI32(_iter604.getValue());
            }
            oprot.writeMapEnd();
          }
          oprot.writeFieldEnd();
      ...
      if (struct.component_debug != null) {
        if (struct.is_set_component_debug()) {
          oprot.writeFieldBegin(COMPONENT_DEBUG_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, DebugOptions> _iter605 : struct.component_debug.entrySet())
            {
  ...
  private static class StormBaseTupleScheme extends TupleScheme<StormBase> {
      ...
      if (struct.is_set_component_executors()) {
        {
          ...
          for (Map.Entry<String, Integer> _iter606 : struct.component_executors.entrySet())
          {
            oprot.writeString(_iter606.getKey());
            oprot.writeI32(_iter606.getValue());
          }
        }
      }
      if (struct.is_set_launch_time_secs()) {
      ...
      if (struct.is_set_component_debug()) {
        {
          ...
          for (Map.Entry<String, DebugOptions> _iter607 : struct.component_debug.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, StormBase struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map608 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.I32, iprot.readI32());
          struct.component_executors = new HashMap<String,Integer>(2*_map608.size);
          String _key609;
          int _val610;
          for (int _i611 = 0; _i611 < _map608.size; ++_i611)
          {
            ...
            struct.component_executors.put(_key609, _val610);
          }
        }
        struct.set_component_executors_isSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          org.apache.thrift.protocol.TMap _map612 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.component_debug = new HashMap<String,DebugOptions>(2*_map612.size);
          String _key613;
          DebugOptions _val614;
          for (int _i615 = 0; _i615 < _map612.size; ++_i615)
          {
            _key613 = iprot.readString();
            _val614 = new DebugOptions();
            _val614.read(iprot);
            struct.component_debug.put(_key613, _val614);
          }
        }
        struct.set_component_debug_isSet(true);
      }
