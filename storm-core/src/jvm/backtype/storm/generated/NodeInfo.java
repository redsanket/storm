...
public class NodeInfo implements org.apache.thrift.TBase<NodeInfo, NodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<NodeInfo> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // PORT
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set396 = iprot.readSetBegin();
                struct.port = new HashSet<Long>(2*_set396.size);
                long _elem397;
                for (int _i398 = 0; _i398 < _set396.size; ++_i398)
                {
                  _elem397 = iprot.readI64();
                  struct.port.add(_elem397);
                }
                iprot.readSetEnd();
              }
  ...
  private static class NodeInfoTupleScheme extends TupleScheme<NodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeInfo struct) throws org.apache.thrift.TException {
      ...
      struct.set_node_isSet(true);
      {
        org.apache.thrift.protocol.TSet _set401 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.I64, iprot.readI32());
        struct.port = new HashSet<Long>(2*_set401.size);
        long _elem402;
        for (int _i403 = 0; _i403 < _set401.size; ++_i403)
        {
          _elem402 = iprot.readI64();
          struct.port.add(_elem402);
        }
      }
      struct.set_port_isSet(true);
    }
