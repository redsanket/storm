            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map616.size);
                ExecutorInfo _key617;
                ExecutorStats _val618;
                for (int _i619 = 0; _i619 < _map616.size; ++_i619)
                {
                  _key617 = new ExecutorInfo();
                  _key617.read(iprot);
                  _val618 = new ExecutorStats();
                  _val618.read(iprot);
                  struct.executor_stats.put(_key617, _val618);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      if (struct.executor_stats != null) {
        oprot.writeFieldBegin(EXECUTOR_STATS_FIELD_DESC);
        {
          ...
          for (Map.Entry<ExecutorInfo, ExecutorStats> _iter620 : struct.executor_stats.entrySet())
          {
            _iter620.getKey().write(oprot);
  ...
  private static class ClusterWorkerHeartbeatTupleScheme extends TupleScheme<ClusterWorkerHeartbeat> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      oprot.writeString(struct.storm_id);
      {
        ...
        for (Map.Entry<ExecutorInfo, ExecutorStats> _iter621 : struct.executor_stats.entrySet())
        {
          _iter621.getKey().write(oprot);
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, ClusterWorkerHeartbeat struct) throws org.apache.thrift.TException {
      ...
      struct.set_storm_id_isSet(true);
      {
        org.apache.thrift.protocol.TMap _map622 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRUCT, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
        struct.executor_stats = new HashMap<ExecutorInfo,ExecutorStats>(2*_map622.size);
        ExecutorInfo _key623;
        ExecutorStats _val624;
        for (int _i625 = 0; _i625 < _map622.size; ++_i625)
        {
          _key623 = new ExecutorInfo();
          _key623.read(iprot);
          _val624 = new ExecutorStats();
          _val624.read(iprot);
          struct.executor_stats.put(_key623, _val624);
        }
      }
      struct.set_executor_stats_isSet(true);
      struct.time_secs = iprot.readI32();
