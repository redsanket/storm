...
public class LogConfig implements org.apache.thrift.TBase<LogConfig, LogConfig._Fields>, java.io.Serializable, Cloneable, Comparable<LogConfig> {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.named_logger_level = new HashMap<String,LogLevel>(2*_map672.size);
                String _key673;
                LogLevel _val674;
                for (int _i675 = 0; _i675 < _map672.size; ++_i675)
                {
                  _key673 = iprot.readString();
                  _val674 = new LogLevel();
                  _val674.read(iprot);
                  struct.named_logger_level.put(_key673, _val674);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.named_logger_level != null) {
        if (struct.is_set_named_logger_level()) {
          oprot.writeFieldBegin(NAMED_LOGGER_LEVEL_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, LogLevel> _iter676 : struct.named_logger_level.entrySet())
            {
  ...
  private static class LogConfigTupleScheme extends TupleScheme<LogConfig> {
      ...
      if (struct.is_set_named_logger_level()) {
        {
          ...
          for (Map.Entry<String, LogLevel> _iter677 : struct.named_logger_level.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, LogConfig struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map678 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.named_logger_level = new HashMap<String,LogLevel>(2*_map678.size);
          String _key679;
          LogLevel _val680;
          for (int _i681 = 0; _i681 < _map678.size; ++_i681)
          {
            _key679 = iprot.readString();
            _val680 = new LogLevel();
            _val680.read(iprot);
            struct.named_logger_level.put(_key679, _val680);
          }
        }
        struct.set_named_logger_level_isSet(true);
      }
