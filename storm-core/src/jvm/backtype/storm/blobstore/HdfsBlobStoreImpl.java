...
public class HdfsBlobStoreImpl {
  ...
  public BlobStoreFile read(String key) throws IOException {
    return new HdfsBlobStoreFile(getKeyDir(key), BlobStoreFile.BLOBSTORE_DATA_FILE, _hadoopConf);
  }
  ...
  public void deleteKey(String key) throws IOException {
    ...
    HdfsBlobStoreFile pf = new HdfsBlobStoreFile(keyDir, BlobStoreFile.BLOBSTORE_DATA_FILE,
        _hadoopConf);
    pf.delete();
    delete(keyDir);
  }
